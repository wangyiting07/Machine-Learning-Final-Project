...
pattern1 = train_img[:20000]
normal = train_img[20000:30000]
pattern2 = train_img[30000:]

pattern1_lbl = train_lbl[:20000]
normal_lbl = train_lbl[20000:30000]
pattern2_lbl = train_lbl[30000:]
...
def create_nn(batch_size=200, learning_rate=0.001, epochs=100,
              log_interval=10):
...
with open('pattern_add_v3.csv', 'w',newline='') as outfile:
